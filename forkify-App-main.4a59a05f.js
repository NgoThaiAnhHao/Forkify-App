...
const updateServings = function(newServings) {
    ...
    // newQt = oldQt * newServings / oldsServings // 2 * 8 / 4 = 4
    });
...
const KEY = 'de79b127-3dce-4009-bfc4-7c1b602b38d6';
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _buttonMarkup(curPage, status, arrow) {
        return status === 'next' ? `
        <button data-goto="${curPage}" class="btn--inline pagination__btn--${status}">
    ...
    _generateMarkup() {
        ...
        if (curPage === 1 && numPages > 1) return this._buttonMarkup(curPage + 1, 'next');
        // Last page
        if (curPage === numPages && numPages > 1) return this._buttonMarkup(curPage - 1, 'prev');
        // Other page
        if (curPage < numPages) return this._buttonMarkup(curPage + 1, 'next') + this._buttonMarkup(curPage - 1, 'prev');
...
//# sourceMappingURL=forkify-App-main.4a59a05f.js.map
